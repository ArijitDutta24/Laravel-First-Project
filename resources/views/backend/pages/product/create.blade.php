            ...
            <div class="card-body">
              <form method="post" action="{{ route('admin.product.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <textarea name="description" rows="8" cols="80" class="form-control" placeholder="Product Description Here...."></textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" name="qty" id="exampleInputEmail1" placeholder="Product Quantity"> 
                </div>
                <div class="form-group">
